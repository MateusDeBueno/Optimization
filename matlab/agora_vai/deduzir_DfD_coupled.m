...
[x0s.f1, ts.f1, idab.f1, hb.f1, HB.f1, Ip.f1, Is.f1, iME.f1, idrm.f1, ilrm.f1, iLrm.f1, iSwPrm.f1, iSwSrm.f1] = simplify_DfD(phi_num(1));
[x0s.f2, ts.f2, idab.f2, hb.f2, HB.f2, Ip.f2, Is.f2, iME.f2, idrm.f2, ilrm.f2, iLrm.f2, iSwPrm.f2, iSwSrm.f2] = simplify_DfD(phi_num(2));
...
text(400,1.6,'HS in primary','Interpreter', 'Latex','FontSize', 14) 
text(400,0.35,'HS in secondary','Interpreter', 'Latex','FontSize', 14) 

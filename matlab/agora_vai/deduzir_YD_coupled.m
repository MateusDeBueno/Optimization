...
phi_num = [deg2rad(40),deg2rad(110)];  %[MUDAR]
[x0s.f1, ts.f1, idab.f1, hb.f1, HB.f1, Ip.f1, Is.f1, iME.f1, idrm.f1, ilrm.f1, iLrm.f1, iSwPrm.f1, iSwSrm.f1] = simplify_YD(phi_num(1));
[x0s.f2, ts.f2, idab.f2, hb.f2, HB.f2, Ip.f2, Is.f2, iME.f2, idrm.f2, ilrm.f2, iLrm.f2, iSwPrm.f2, iSwSrm.f2] = simplify_YD(phi_num(2));
...
intervalo.f1 = [deg2rad(30) deg2rad(60)];
intervalo.f2 = [deg2rad(60) deg2rad(120)];
...
text(45,1.7,'HS in primary','Interpreter', 'Latex','FontSize', 14) 
text(45,0.15,'HS in secondary','Interpreter', 'Latex','FontSize', 14) 
text(100,0.9,'SS in both','Interpreter', 'Latex','FontSize', 14) 
...
text(800,1.5,'HS in primary','Interpreter', 'Latex','FontSize', 14) 
text(800,0.25,'HS in secondary','Interpreter', 'Latex','FontSize', 14) 
text(3000,0.66,'SS in both','Interpreter', 'Latex','FontSize', 14) 

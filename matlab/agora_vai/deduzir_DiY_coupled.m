...
[x0s.f1, ts.f1, idab.f1, hb.f1, HB.f1, Ip.f1, Is.f1, iME.f1, idrm.f1, ilrm.f1, iLrm.f1, iSwPrm.f1, iSwSrm.f1] = simplify_DiY(phi_num(1));
[x0s.f2, ts.f2, idab.f2, hb.f2, HB.f2, Ip.f2, Is.f2, iME.f2, idrm.f2, ilrm.f2, iLrm.f2, iSwPrm.f2, iSwSrm.f2] = simplify_DiY(phi_num(2));
...
figure
hold on
[C,h] = contour(x1*1e3, y1, z1,[0.94 0.96 0.98 0.99 1 1.005 1.01 1.04 1.1], 'ShowText', 'on','Color',color1);
h.LineWidth = 1.5;
clabel(C,h,'FontSize',15,'Color',[0 0 0],'LineWidth',2)
[C,h] = contour(x2*1e3, y2, z2,[0.94 0.96 0.98 0.99 1 1.005 1.01 1.04 1.1], 'ShowText', 'on','Color',color1);
h.LineWidth = 1.5;
clabel(C,h,'FontSize',15,'Color',[0 0 0],'LineWidth',2)
hold off
grid on
...
text(30,1.7,'SS in both','Interpreter', 'Latex','FontSize', 14) 
...
text(2800,1.75,'SS in both','Interpreter', 'Latex','FontSize', 14) 
